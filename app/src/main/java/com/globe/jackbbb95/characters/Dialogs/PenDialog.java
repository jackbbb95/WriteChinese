...
import com.globe.jackbbb95.characters.ActivitiesAndFragments.WriteActivityFragment;
...
public class PenDialog extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        penSlider.setValue(WriteActivityFragment.getPenSize(), true);


        final String penSizeText = ("Pen Size: " + WriteActivityFragment.getPenSize());
        ...
        save.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                WriteActivityFragment.setPenSize(penSlider.getValue());
                WriteActivityFragment.getConfig().setStrokeWidth(penSlider.getValue());
