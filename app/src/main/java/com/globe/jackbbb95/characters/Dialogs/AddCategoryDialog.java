...
import com.globe.jackbbb95.characters.ActivitiesAndFragments.CategoryListActivityFragment;
        ...
        create.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (title.length() < 1) {
                    ...
                    list.add(thingToAdd);
                    CategoryListActivityFragment.getCategoryAdapter().notifyItemInserted(list.indexOf(thingToAdd));
                    CategoryListActivityFragment.saveList(getContext());
                    CategoryListActivityFragment.getEmptyText().setVisibility(View.GONE);
